...
model_of_temperature = tf.keras.models.Sequential([

    tf.keras.layers.LSTM(32, input_shape=(train_X.shape[1], train_X.shape[2]), return_sequences=False),
...
h = model_of_temperature.fit(train_X, train_y, validation_split=0.2, epochs=32, batch_size=25)
